...
// Can't hurt to experiment. 28 leaves 20 bytes of free SRAM with the current grbl version.
//#define BLOCK_BUFFER_SIZE 20  // Uncomment to override default in planner.h.
